...
[![Click to watch YouTube demo](https://i.imgur.com/1KTWqfI.png)](https://www.youtube.com/watch?v=wVqM_2mCdIk)
...
- **Search By Customer Segment**: Results will be displayed based on customer segment.
  ...
  <pre>
  Download Dataset From <a href="https://github.com/MuhammadSaad-ml/Sales-Analytics/blob/main/Sales%20Data.csv">Sales Data</a>
</pre>
...
**4.Click on the files containg  <a href="https://github.com/MuhammadSaad-ml/Sales-Analytics/blob/main/Pre-processing.py">Pre-processing.py</a>**
<pre>
Pre-processing.py
